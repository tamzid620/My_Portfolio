...
const Navbar = () => {
  ...
  const navigation =
    <>
      <NavLink to="/"><li className="font-bold px-2">Home</li></NavLink>
      <NavLink to="/myproject"><li className="font-bold">Projects</li></NavLink>
      <NavLink to="/blog"><li className="font-bold">About Me</li></NavLink>
    </>
